...
for i in range(maxChar,minChar,-1):    
    for j in range(maxChar,minChar,-1):
        for k in range(maxChar,minChar,-1):
            for l in range(maxChar,minChar,-1):
                for m in range(maxChar,minChar,-1):
